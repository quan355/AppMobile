...
export default function CreateRecipeScreen() {
  ...
  const [cookTime, setCookTime] = useState('45 phút');
...
const newRecipe = {
  ...
  author: `Bởi ${username}`,
  image: selectedImage,
  category: category.trim(), // ✅ Thêm vào đây
};
      ...
      addNotification(notification, (newNotifications) => {
        ...
        // Điều hướng đến NotificationsScreen và thông báo ProfilepageScreen
        navigation.navigate('Notifications', {
          notifications: newNotifications,
          newRecipeAdded: true, // Thêm tín hiệu để làm mới ProfilepageScreen
        });
      });
    } catch (error) {
